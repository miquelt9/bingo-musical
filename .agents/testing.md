...
GitHub Actions workflow `.github/workflows/ci.yml` runs the unit tests and that smoke on pull requests and on pushes to `main`. The job uses Node 22 because jsdom 30 does not start under Node 20.
