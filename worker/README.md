...
| `GET` | `/api/youtube/search?q=...&limit=8` | Normalized YouTube search via curated Piped/Invidious backends |
| `GET` | `/api/youtube/video/:id` | Normalized YouTube video metadata |
| `GET` | `/api/youtube/related/:id?limit=12` | Related video suggestions for a YouTube id |
| `GET` | `/api/youtube/playlist/:id` | Playlist title + up to 50 video hits |
